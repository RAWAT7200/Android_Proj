...
public class SinchService extends Service {
    ...
    private static final String APP_KEY = "238f9c73-8720-4a66-9201-f978b0b6ea48";
    private static final String APP_SECRET = "6MuKkuQtU0Wn/zzopduQ7g==";
    ...
    private class SinchCallClientListener implements CallClientListener {
        ...
        public void onIncomingCall(CallClient callClient, Call call) {
            ...
            intent.putExtra(IS_VIDEO_CALL, call.getDetails().isVideoOffered());
