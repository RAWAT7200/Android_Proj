 ...
 */
public class MLAInstructorAdapter extends RecyclerSwipeAdapter<MLAInstructorAdapter.SimpleViewHolder> {
    ...
    public static class SimpleViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final MLAInstructorDetails item, final OnItemClickListener listener) {
            ...
            txtUserName.setText(item.getIdInstructor());
    ...
    private List<MLAInstructorDetails> mDataset;

    OnItemClickListener<MLAInstructorDetails> listener;

    //protected SwipeItemRecyclerMangerImpl mItemManger = new SwipeItemRecyclerMangerImpl(this);

    public MLAInstructorAdapter(Context context, List<MLAInstructorDetails> objects, OnItemClickListener<MLAInstructorDetails> onItemClickListenerener) {
    ...
    public void onBindViewHolder(final SimpleViewHolder viewHolder, final int position) {
        MLAInstructorDetails item = mDataset.get(position);
